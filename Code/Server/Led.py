...
class Led:
    def __init__(self, brightness=255):
        ...
        self.strip = Adafruit_NeoPixel(
            LED_COUNT, LED_PIN, LED_FREQ_HZ, LED_DMA, LED_INVERT, brightness, LED_CHANNEL)
    ...
    def rainbowCycle(self, strip=None, wait_ms=20, iterations=5):
    ...
    async def rainbowCycleAsync(self, strip=None, wait_ms=20):
        """Draw rainbow that uniformly distributes itself across all pixels."""
        if not strip:
            strip = self.strip
        for j in range(256):
